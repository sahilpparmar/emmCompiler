...
demo:	driveParse.o E--_lexer.o E--_parser.o Ast.o STEClasses.o SymTabMgr.o Value.o Type.o SymTabEntry.o Error.o ParserUtil.o SymTab.o InterCode.o CodeOpt.o FinalMachineCodeGen.o EventHandler.o
	$(CXX) -o $@ $^ -lfl
...
FinalMachineCodeGen.o: FinalMachineCodeGen.h FinalMachineCodeGen.C
