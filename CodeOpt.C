...
InterCodesClass* CodeOpt::constant_folding(InterCodesClass* org) {
    ...
    ExprNode** operands = (ExprNode**)dupICodeVector->at(1)->get3Operands();
    ...
    if (operands[0] && operands[1] && operands[2]) {
        ...
        if (OpNode::OpCode::PLUS == dupICodeVector->at(1)->getsubCode())
        {
            ...
            tempICodeVector->at(1)->setSubCode(OpNode::OpCode::ASSIGN);
            //tempICodeVector->at(1)->set3Operands((void**)operands);
            //tempICodeVector->push_back(dupICodeVector->at(1));
        }
